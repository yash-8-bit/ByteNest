  ...
  return (
    <>   {loading && <Loading />}
      ...
      >
        ...
        <div className='m-2 w-full bg-white  sm:w-96'>
          <Link to={"/"} >
            <p className='text-center p-2'>Byte-Nest</p></Link>
          ...
          sm:px-6">
            <div className="z-10 mx-auto max-w-md">
              <span className='grid h-20 w-20 place-items-center rounded-full bg-sky-500 transition-all duration-300 '>
                <CiFileOn className='text-white' size={40} />
              </span>
              <div
                className="pt-5 text-base leading-7 text-gray-600 transition-all duration-300">
                <p>
                  file name - {data?.name}
                </p>
                <p>
